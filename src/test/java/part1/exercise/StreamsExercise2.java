...
public class StreamsExercise2 {
    ...
    public void employersStuffLists() {
        ...
        Stream<PersonEmployerPair> personEmployerPairStream = employees.stream()
                .flatMap(e -> e.getJobHistory()
                        .stream().map(j -> new PersonEmployerPair(e.getPerson(), j.getEmployer())));
    ...
    public void indexByFirstEmployer() {
        ...
        Map<String, List<Person>> employeesIndex = personEmployerPairStream
                .collect(Collectors.groupingBy(PersonEmployerPair::getEmployer,
                        Collectors.mapping(PersonEmployerPair::getPerson, Collectors.toList())));
        ...
        Map<String, Person> employeesIndex = getEmployees().stream()
                ...
                .collect(Collectors.groupingBy(PersonEmployerDuration::getEmployer,
                        Collectors.collectingAndThen(
                                Collectors.maxBy(Comparator.comparing(PersonEmployerDuration::getDuration)), p -> p.get().getPerson()
                        )));
