...
public class LambdaExercise {
    ...
    public void supply() {
        ...
        // person from Supplier
        final Supplier<Person> getPerson = () -> Optional.of(person).orElse(
                new Person("empty", "empty", 0));
    ...
    public void combineFunctions() {
        ...
        final Function<Person, Integer> getPersonNameLength1 = (pn) -> getStringLength
                .apply(getPersonName.apply(pn));

        // get person name length using getPersonName and getStringLength with andThen
        final Function<Person, Integer> getPersonNameLength2 = getPersonName.andThen(
                getStringLength);
    ...
    private <T, R> Predicate<T> combine(Function<T, R> f, Predicate<R> p) {
        return person -> p.test(f.apply(person));
    }
    ...
    public void methodReference() {
        ...
        final Predicate<String> isJohnString = this::isJohn;
    ...
    private boolean isJohn(String toCheck) {
        return toCheck.equals("John");
    }
