...
public class LambdaExercise {
    ...
    public void combineFunctions() {
        ...
        final Function<Person, Integer> getPersonNameLength1 = person -> getStringLength
            .apply(getPersonName.apply(person));

        // TODO get person name length using getPersonName and getStringLength with andThen
        final Function<Person, Integer> getPersonNameLength2 = person -> getPersonName
    ...
    private <T, R> Predicate<T> combine(Function<T, R> f, Predicate<R> p) {
        // TODO
        return e -> p.test(f.apply(e));
    }

    private static boolean isJohnString(String e) {
        return e.equals("John");
    }
    ...
    public void methodReference() {
        ...
        final Predicate<String> isJohnString = LambdaExercise::isJohnString; // TODO using method reference check that "John" equals string parameter
