...
public class LambdaExercise {
    ...
    public void supply() {
        ...
        final Supplier<Person> getPerson = (() -> person); //null; // TODO return person from Supplier
    ...
    public void function() {
        final Function<Person, String> getPersonName1 = (person1 -> person1.getFirstName());//null; // TODO get the name of person using expression lambda

        final Function<Person, String> getPersonName2 = (Person::getFirstName);//null; // TODO get the name of person using method reference
    ...
    public void combineFunctions() {
        final Function<Person, String> getPersonName = (person1 -> person1.getFirstName());//null; // TODO get the name of person

        assertEquals("John", getPersonName.apply(new Person("John", "Galt", 30)));

        final Function<String, Integer> getStringLength = (String::length);//null; // TODO get string length
        ...
        final Function<Person, Integer> getPersonNameLength1 = (person -> getStringLength.apply(getPersonName.apply(person)));//null;

        // TODO get person name length using getPersonName and getStringLength with andThen
        final Function<Person, Integer> getPersonNameLength2 = (getPersonName.andThen(getStringLength)); //null;
    ...
    private <T, R> Predicate<T> combine(Function<T, R> f, Predicate<R> p) {
        return (object -> p.test(f.apply(object)));
    }
    ...
    public void methodReference() {
        ...
        final Predicate<String> isJohnString = (string -> string.equals("John")); // TODO using method reference check that "John" equals string parameter
