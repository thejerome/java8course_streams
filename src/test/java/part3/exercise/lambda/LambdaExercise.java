...
public class LambdaExercise {
    ...
    public void supply() {
        ...
        final Supplier<Person> getPerson = new Supplier<Person>() {
            @Override
            public Person get() {
                return new Person("John", "Galt", 30);
            }
        };
    ...
    public void function() {
        ...
        final Function<Person, String> getPersonNameAndLogIt = s -> {
    ...
    public void combineFunctions() {
        ...
        final Function<Person, Integer> getPersonNameLength1 = s -> getStringLength.apply(getPersonName.apply(s));
    ...
    public void methodReference() {
        ...
        final Predicate<String> isJohnString = p -> {
            return p.equals("John");
        };
