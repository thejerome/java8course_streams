...
public class LambdaExercise {
    ...
    public void supply() {
        ...
        final Supplier<Person> getPerson = () -> person; // return person from Supplier
    ...
    public void function() {
        final Function<Person, String> getPersonName1 = person -> person.getFirstName(); // get the name of person using expression lambda

        final Function<Person, String> getPersonName2 = Person::getFirstName; // get the name of person using method reference
    ...
    public void combineFunctions() {
        final Function<Person, String> getPersonName = Person::getFirstName; // get the name of person

        assertEquals("John", getPersonName.apply(new Person("John", "Galt", 30)));

        final Function<String, Integer> getStringLength = String::length; // get string length
...
//         throw new UnsupportedOperationException();
    ...
    public void methodReference() {
        //  use only method reverences here.
        ...
        final Predicate<String> isJohnString = "John"::equals; // using method reference check that "John" equals string parameter
