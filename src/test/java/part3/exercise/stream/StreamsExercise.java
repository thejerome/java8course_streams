    ...
    public void getDurationsForEachPersonByPosition() {
        ...
        final List<PersonPositionDuration> personPositionDurations =  employees.stream()
                                                                               ...
                                                                               .flatMap(ppi -> ppi.getDurationByPositionIndex()
                                                                                                  .entrySet()
                                                                                                  .stream()
                                                                                                  .map(s -> new PersonPositionDuration(ppi.getPerson(), s.getKey(), s.getValue())))
                                                                               .collect(toList());
    ...
    public void getCoolestPersonByPosition1() {
        ...
        final Map<String, PersonPositionDuration> coolestPersonByPosition = employees.stream()
                                                                                     ...
                                                                                     .flatMap(ppi -> ppi.getDurationByPositionIndex()
                                                                                                        ...
                                                                                                        .stream()
                                                                                                        .map(s -> new PersonPositionDuration(ppi.getPerson(), s.getKey(), s.getValue())))
                                                                                     .collect(toMap(PersonPositionDuration::getPosition, identity(), maxBy(
                                                                                         comparingInt(PersonPositionDuration::getDuration))));
