...
public class StreamsExercise {
    ...
    public void getDurationsForEachPersonByPosition() {
        ...
        final List<PersonPositionDuration> personPositionDurations = employees.stream()
                .flatMap(e -> getPersonPositionIndex(e).durationByPositionIndex.entrySet().stream()
                        .map(me -> new PersonPositionDuration(
                                e.getPerson(), me.getKey(), me.getValue())))
                .collect(Collectors.toList());
        ...
        final Map<String, PersonPositionDuration> coolestPersonByPosition = employees.stream()
                ...
                .collect(Collectors
                        .groupingBy(PersonPositionDuration::getPosition,
                                Collectors
                                        .collectingAndThen(Collectors.maxBy(Comparator.comparing(
                                                PersonPositionDuration::getDuration)),
                                                o -> o.orElse(new PersonPositionDuration(
                                                        new Person("emptyPerson",
                                                                "emptyPerson", 0),
                                                        "emptyPersonPositionDuration",
                                                        0))
                                        ))
                );
