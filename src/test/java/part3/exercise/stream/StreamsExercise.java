...
public class StreamsExercise {
    ...
    public void indexPersonsByEmployer1() {
        ...
        final Map<String, List<PersonEmployer>> index = employees.stream()
                ...
                .collect(groupingBy(personEmployer -> personEmployer.getEmployer()));
    ...
    public void indexPersonsByEmployer2() {
        ...
        final Map<String, List<Person>> index = employees.stream()
                ...
                .collect(groupingBy(
                        personEmployer -> personEmployer.getEmployer(),
                        Collectors.mapping(
                                personEmployer -> personEmployer.getPerson(),
                                Collectors.toList()
                        )
                ));
    ...
    public void getSumPersonDuration() {
        ...
        final Map<Person, Integer> personDuration =  employees.stream()
                .collect(groupingBy(
                        ...
                        Collectors.mapping(
                                employee -> sumAllPersonDurations(employee),
                                Collectors.summingInt(duration -> duration.getDuration())
                        )
                ));// use sumAllPersonDurations
    ...
    private static PersonPositionIndex getPersonPositionIndex(Employee e) {
        return e.getJobHistory().stream().collect(
                collectingAndThen(
                        toMap(jobHistoryEntry -> jobHistoryEntry.getPosition(),
                                jobHistoryEntry -> jobHistoryEntry.getDuration(),
                                (v1, v2) -> v1 + v2),
    ...
    public void getSumDurationsForPersonByPosition() {
        ...
        final List<PersonPositionIndex> personIndexes = employees.stream()
                ...
                .collect(Collectors.toList()); // use getPersonPositionIndex
    ...
    public void getDurationsForEachPersonByPosition() {
        ...
        final List<PersonPositionDuration> personPositionDurations = employees.stream()
                .map(StreamsExercise::getPersonPositionIndex)
                .flatMap(personPositionIndex -> personPositionIndex
                        .durationByPositionIndex
                        .entrySet()
                        .stream()
                        .map(entry -> new PersonPositionDuration(personPositionIndex.person, entry.getKey(), entry.getValue()))
                ).collect(Collectors.toList());
    ...
    public void getCoolestPersonByPosition1() {
        ...
        final Map<String, PersonPositionDuration> coolestPersonByPosition = employees.stream()
                ...
                .flatMap(personPositionIndex -> personPositionIndex.durationByPositionIndex.entrySet().stream()
                        ...
                        Function.identity(),
                        BinaryOperator.maxBy(Comparator.comparingInt(personPositionDuration -> personPositionDuration.getDuration()))
                ));
    ...
    public void getCoolestPersonByPosition2() {
        ...
        final Map<String, Person> coolestPersonByPosition = employees.stream()
                ...
                .flatMap(i -> i.getDurationByPositionIndex().entrySet().stream()
                        .map(entry -> new PersonPositionDuration(i.getPerson(), entry.getKey(), entry.getValue())))
                .collect(groupingBy(personPositionDuration -> personPositionDuration.getPosition(),
                        collectingAndThen(Collectors.maxBy(comparing(personPositionDuration -> personPositionDuration.getDuration())), p -> p.get().getPerson()))
                );
